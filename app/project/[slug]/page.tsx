// app/components/project/[slug]/page.tsx
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: project ? `Learn more about ${project.title} - ${project.description}` : "",
  };
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="prose prose-lg max-w-none">
                <div className="prose-headings:text-gray-900 prose-p:text-gray-600 prose-li:text-gray-600 prose-strong:text-gray-900 prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline">
            ...
            <div className="space-y-6">
              {/* Project Info Card */}
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h3 className="font-semibold text-gray-900 mb-4 text-lg">Project Details</h3>
              ...
              {/* Technologies Used */}
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h3 className="font-semibold text-gray-900 mb-4 text-lg">Technologies Used</h3>
